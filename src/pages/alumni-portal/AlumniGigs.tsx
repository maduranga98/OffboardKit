      ...
      {filtered.length === 0 ? (
        ...
        <div className="space-y-4">
          {filtered.map((gig) => {
            ...
            return (
              <div key={gig.id} className="bg-white border border-navy/10 rounded-xl p-5 space-y-3">
                {/* Title row */}
                ...
                {gig.status === "sent" && (
                  <div className="space-y-2 pt-1 border-t border-navy/5">
                    <textarea
                      rows={2}
                      value={notes[gig.id] ?? ""}
                      onChange={(e) => setNotes((p) => ({ ...p, [gig.id]: e.target.value }))}
                    ...
                    <div className="flex gap-2">
                      <Button
                        onClick={() => handleRespond(gig, "accepted")}
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => handleRespond(gig, "declined")}
                        disabled={actionLoading[gig.id]}
                      >
                        Decline
                      </Button>
